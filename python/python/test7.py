...
def getRoot3(id, i):
   try:
      ...
      if id!=getParentID[id] and id!=getParentID[getParentID[id]] and id!=getParentID[getParentID[getParentID[id]]] and id!=getParentID[getParentID[getParentID[getParentID[id]]]]:
